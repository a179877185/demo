...
/**
 * Created by SHENMM on 2017/10/17.
 */
...
//    private static Logger logger = Logger.getLogger(PropertiesUtil.class);
    ...
    /**
     * 取出Property，但以System的Property优先,取不到返回空字
     */
    ...
    /**
     * 取出Integer类型的Property，但以System的Property优先.如果都为Null则返回Default值，如果内容错误则抛出
     */
    ...
    private Properties loadProperties(String... resourcesPaths) {
        ...
        for (String location : resourcesPaths) {
            ...
            try {
                is = new InputStreamReader(getClass().getClassLoader().getResourceAsStream(location), "UTF-8");
                props.load(is);
